...
return [
    ...
    'avatar_removed' => 'تمت إزالة صورة المستخدم بنجاح.',
    ...
    'cv_contract' => [
        'statuses' => [
            'no_cv' => 'لا توجد سيرة ذاتية جاهزة بعد',
            'processing' => 'جاري تحليل السيرة الذاتية',
            'review_required' => 'السيرة الذاتية بحاجة إلى مراجعة',
            'suggestions_review_required' => 'التغييرات المقترحة بحاجة إلى مراجعة',
            'ready_for_confirmation' => 'السيرة الذاتية جاهزة للتأكيد',
            'confirmed' => 'سيرتك الذاتية جاهزة',
