...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'technical_knowledge_score' => 'technical knowledge score',
    ...
    'custom_messages' => [
        ...
        'image_invalid' => 'The uploaded file is not a valid decodable image.',
        'image_dimensions_exceeded' => 'The image dimensions are too large to process safely.',
        'image_processing_failed' => 'The image could not be processed. Please try a different image.',
        'image_processing_unavailable' => 'Image processing with WebP support is unavailable.',
        ...
        'salary_range' => 'The salary max field must be greater than or equal to salary min.',
        ...
        'max_score_managed' => 'The maximum score is calculated from the test questions.',
        'test_catalog_job_seeker' => 'Test catalog access is not available for job seekers.',
        'job_location_required' => 'The location field is required for on-site and hybrid jobs.',
        'skill_contract_conflict' => 'Legacy and separated skill contracts cannot be combined in one request.',
        'skill_contract_required' => 'At least one skill contract is required.',
        'skill_contract_duplicate' => 'A skill cannot be both required and nice-to-have in the same request.',
