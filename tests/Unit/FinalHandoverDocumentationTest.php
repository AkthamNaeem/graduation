...
class FinalHandoverDocumentationTest extends TestCase
{
    ...
    private function assertProtectedBaselines(array $manifest): void
    {
        ...
        $approvedDocumentation = array_merge($approvedDocumentation, [
            ...
            // Approved Task 5 secure CV preview and profile availability contract.
            'app/Data/ProfilePageData.php',
            'app/Http/Controllers/Api/V1/CV/CVController.php',
            'app/Http/Requests/Api/V1/Profile/UpdateJobSeekerProfileRequest.php',
            'app/Http/Requests/Concerns/ReturnsCityValidationCodes.php',
            'app/Http/Resources/Api/V1/CurrentCVResource.php',
            'app/Http/Resources/Api/V1/ProfilePageResource.php',
            'app/Models/JobSeekerProfile.php',
            'app/Services/CV/CandidateCVStateResolver.php',
            'app/Services/CVService.php',
            'app/Services/Home/ProfileCompletenessService.php',
            'app/Services/PrivateFileStorageService.php',
            'app/Services/ProfilePageService.php',
            'lang/ar/cv.php',
            'lang/ar/domain_errors.php',
            'lang/ar/profile.php',
            'lang/en/cv.php',
            'lang/en/domain_errors.php',
            'lang/en/profile.php',
            'postman/Smart Recruitment Platform - Environment.postman_environment.json',
            'postman/Smart Recruitment Platform - Mobile App.postman_collection.json',
            'postman/Smart Recruitment Platform - Web App.postman_collection.json',
            'routes/api/v1.php',
            'tests/Feature/Api/V1/CVUpdateConfirmationWorkflowTest.php',
            'tests/Feature/Api/V1/ProfileCompletenessAttentionTest.php',
            'tests/Feature/Api/V1/SingleCurrentCVContractTest.php',
            'tests/Feature/PrivateFileStorageTest.php',
            'tests/Unit/ProfilePageCompletenessServiceTest.php',
